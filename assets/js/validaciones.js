...
const mensajesDeError = {
  ...
  email: {
    valueMissing: "Este debe tener un email no puede estar vacio",
    typeMismatch: "El correo no es valido",
  },
  password:{
    valueMissing: "Necesitas una contraseña no puede estar vacio",
  ...
  nacimiento:{
    valueMissing:"Debes poner tu fecha de nacimiento",
    customError: "Debes tener al menos 18 años de edad"   
  },
  numero: {
    valueMissing:"Este campo no debe estar vacio",
    patternMismatch: "El formato requerido es en numeros xxx-xxx-xxxx"
  },
  direccion: {
    valueMissing:"Este campo no debe estar vacio",
